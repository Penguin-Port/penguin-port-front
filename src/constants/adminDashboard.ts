...
export const DASHBOARD_METRICS: DashboardMetric[] = [
  { label: '활성 이용권', value: '128장', detail: '전일 대비 +12장', tone: 'blue' },
  { label: '오늘 매출', value: '2,840,000원', detail: '어제 대비 23% 증가', tone: 'green' },
  { label: '리워드 달성', value: '24건', detail: '오늘 발행 · 18건 선택 완료', tone: 'purple' },
  { label: '승인 대기', value: '6건', detail: 'AI 제안 검토가 필요해요', tone: 'orange' },
]
...
export const DASHBOARD_APPROVALS: DashboardApproval[] = [
  { id: 'approval-1', type: 'AI 타임세일 추천', description: '오후 2~4시 아메리카노 15%', count: 2 },
  { id: 'approval-2', type: 'AI 재고 프로모션', description: '유통기한 임박 · 케이크 세트 할인', count: 1 },
  { id: 'approval-3', type: 'AI 신메뉴 트렌드', description: '버터떡 · 두쫀쿠 · 말차 디저트', count: 3 },
]
